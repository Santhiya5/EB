    ...
    view_information(String view){
        ...
        add(phoneText);
         ...
         try{
            ...
            ResultSet resultSet = c.s.executeQuery("select * from new_customer where meter_no = '"+view+"'");
            if (resultSet.next()){
        ...
        ImageIcon a1 = new ImageIcon(ClassLoader.getSystemResource("Icon1/viewInfo.png"));
