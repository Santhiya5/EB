...
public class calculate_bill extends JFrame implements ActionListener{
    ...
    calculate_bill(){
        ...
        meternumCho = new Choice();
         try {
            ...
            ResultSet resultSet = c.s.executeQuery("select * from new_customer");
        ...
        panel.add(addressText);
         ...
         try {
            Database c= new Database();
            ResultSet resultSet = c.s.executeQuery("select * from new_customer where meter_no = '"+meternumCho.getSelectedItem()+"' ");
            while (resultSet.next()){
        ...
        add(panel,"Center");
        ImageIcon imageIcon = new ImageIcon(ClassLoader.getSystemResource("Icon1/budget.png"));
    ...
    public void actionPerformed(ActionEvent e) {
         if (e.getSource() == submit){
            ...
            try{
                Database c = new Database();
                c.s.executeUpdate(query_total_bill);
