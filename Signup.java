...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        meterText.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                try{
                    ...
                    ResultSet resultSet = c.s.executeQuery("select * from signup  where meter_no = '"+meterText.getText()+"'");
                    if (resultSet.next()){
        ...
        ImageIcon boyIcon = new ImageIcon(ClassLoader.getSystemResource("Icon1/Signup.png"));
