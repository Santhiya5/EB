...
public class update_information extends JFrame implements ActionListener {
    ...
    update_information(String meter){
        ...
        ImageIcon imageIcon = new ImageIcon(ClassLoader.getSystemResource("Icon1/update.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==update){
            ...
            try{
                Database c = new Database();
                c.s.executeUpdate("update new_customer set address ='"+saddress+"', city = '"+scity+"', state = '"+sstate+"', email = '"+semail+"', phone_no ='"+sphone+"' where meter_no = '"+meter+"'");
